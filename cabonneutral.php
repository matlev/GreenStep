    ...
    <p>
        ...
        <div id ="calc6" style="margin-left:9.3%;float:left; width: 10%">
           3. <select id= "getYear2" onchange="changeYr2()">
                <option>Year</option>
            <?php
...
<br>
        ...
        <font color="#AFD464" style="margin-right:15px">purchasing carbon offsets</font>
            2. <select style="margin-left:0.5%" class="dd3" id="offsource2" onchange="getScope2()">
        ...
        <div id ="calc8" style="float:left; width: 20%">
            4. <select id= "getCost2" onchange="changeCost2()">
